      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-3 bg-secondary rounded-lg border border-border">
              ...
              <p className="text-foreground font-semibold text-sm">{new Date(selectedOrder.createdAt || selectedOrder.date).toLocaleString()}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {mockFlyers.map((flyer, index) => {
            const remainingTime = calculateRemainingTime(flyer.delivery, selectedOrder.createdAt || selectedOrder.date)
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{flyer.title}</p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-secondary rounded-lg border border-border">
                      ...
                      <p className="text-foreground font-semibold">{flyer.title}</p>
                    </div>

                    <div className="p-3 bg-secondary rounded-lg border border-border">
                      <p className="text-xs text-muted-foreground mb-1">Price</p>
                      <p className="text-foreground font-semibold">${flyer.price}</p>
                    </div>
